        ...
        b = (function () {
            ...
            return (
                ...
                (n._slide = function (t, n) {
                    ...
                    if (
                        ("next" === t ? ((i = "carousel-item-left"), (o = "carousel-item-next"), (s = "left")) : ((i = "carousel-item-right"), (o = "carousel-item-prev"), (s = "right")),
                        ...
                        if ((e(r).trigger(s), !s.isDefaultPrevented())) {
                            if (!this._inNavbar && i) {
                                ...
                                "parent" === this._config.reference
                                    ? (l = r)
                                    : a.isElement(this._config.reference) && ((l = this._config.reference), "undefined" != typeof this._config.reference.jquery && (l = this._config.reference[0])),
                    ...
                    if (!n || (3 !== n.which && ("keyup" !== n.type || 9 === n.which)))
                        for (var i = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), o = 0, s = i.length; o < s; o++) {
                            ...
                            if ((n && "click" === n.type && (l.clickEvent = n), a)) {
                                ...
                                if (
                                    e(r).hasClass("show") &&
                                    !(n && (("click" === n.type && /input|textarea/i.test(n.target.tagName)) || ("keyup" === n.type && 9 === n.which)) && e.contains(r, n.target))
                                ) {
                ...
                (t._dataApiKeydownHandler = function (n) {
                    if (
                        !(/input|textarea/i.test(n.target.tagName)
                            ? 32 === n.which || (27 !== n.which && ((40 !== n.which && 38 !== n.which) || e(n.target).closest(".dropdown-menu").length))
                            : !D.test(n.which)) &&
                        !this.disabled &&
